...
type Bootstrap struct {
	...
	// ai_service configures the downstream FastAPI AI service used by the BFF.
	AiService     *AIService `protobuf:"bytes,4,opt,name=ai_service,json=aiService,proto3" json:"ai_service,omitempty"`
...
type AIService struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// base_url is the FastAPI service root, for example http://127.0.0.1:8000.
	BaseUrl string `protobuf:"bytes,1,opt,name=base_url,json=baseUrl,proto3" json:"base_url,omitempty"`
	// timeout applies to normal JSON requests. SSE uses request cancellation instead.
...
func (x *AIService) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\xb9\x01\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x12$\n" +
	"\x04auth\x18\x03 \x01(\v2\x10.kratos.api.AuthR\x04auth\x124\n" +
	"\n" +
	"ai_service\x18\x04 \x01(\v2\x15.kratos.api.AIServiceR\taiService\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xc9\x01\n" +
	"\x04Auth\x12\x1d\n" +
	"\n" +
	"jwt_secret\x18\x01 \x01(\tR\tjwtSecret\x12C\n" +
	"\x10access_token_ttl\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0eaccessTokenTtl\x12E\n" +
	"\x11refresh_token_ttl\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x0frefreshTokenTtl\x12\x16\n" +
	"\x06issuer\x18\x04 \x01(\tR\x06issuer\"[\n" +
	"\tAIService\x12\x19\n" +
	"\bbase_url\x18\x01 \x01(\tR\abaseUrl\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB#Z!emo-ai-service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*AIService)(nil),           // 4: kratos.api.AIService
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 3: kratos.api.Bootstrap.ai_service:type_name -> kratos.api.AIService
	...
	9,  // 8: kratos.api.Auth.access_token_ttl:type_name -> google.protobuf.Duration
	9,  // 9: kratos.api.Auth.refresh_token_ttl:type_name -> google.protobuf.Duration
	9,  // 10: kratos.api.AIService.timeout:type_name -> google.protobuf.Duration
