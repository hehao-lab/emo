...
func wireApp(confServer *conf.Server, confData *conf.Data, confAuth *conf.Auth, aiService *conf.AIService, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	aiChatUsecase := biz.NewAIChatUsecase(aiChatRepo, chatRepo)
	...
	emotionUsecase := biz.NewEmotionUsecase(emotionRepo, profileRepo, emotionAnalyzer)
	emotionService := service.NewEmotionService(emotionUsecase, tokenManager)
