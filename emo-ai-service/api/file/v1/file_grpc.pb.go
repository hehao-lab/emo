...
const (
	FileService_CreateUploadToken_FullMethodName = "/file.v1.FileService/CreateUploadToken"
...
type FileServiceClient interface {
	// 创建上传凭证，返回上传地址、对象 key 和公开访问地址。
	CreateUploadToken(ctx context.Context, in *CreateUploadTokenRequest, opts ...grpc.CallOption) (*UploadToken, error)
	// 登记文件元数据，用于头像、日记附件等业务资源。
	CreateFile(ctx context.Context, in *CreateFileRequest, opts ...grpc.CallOption) (*FileAsset, error)
	// 查询当前用户指定文件元数据。
	GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*FileAsset, error)
	// 删除当前用户指定文件资源记录。
...
func (c *fileServiceClient) CreateUploadToken(ctx context.Context, in *CreateUploadTokenRequest, opts ...grpc.CallOption) (*UploadToken, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UploadToken)
	err := c.cc.Invoke(ctx, FileService_CreateUploadToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) CreateFile(ctx context.Context, in *CreateFileRequest, opts ...grpc.CallOption) (*FileAsset, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileAsset)
...
func (c *fileServiceClient) GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*FileAsset, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileAsset)
...
func (UnimplementedFileServiceServer) CreateUploadToken(context.Context, *CreateUploadTokenRequest) (*UploadToken, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateUploadToken not implemented")
}
func (UnimplementedFileServiceServer) CreateFile(context.Context, *CreateFileRequest) (*FileAsset, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateFile not implemented")
}
func (UnimplementedFileServiceServer) GetFile(context.Context, *GetFileRequest) (*FileAsset, error) {
...
func _FileService_CreateUploadToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateUploadTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).CreateUploadToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_CreateUploadToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).CreateUploadToken(ctx, req.(*CreateUploadTokenRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FileService_CreateUploadToken_Handler,
		},
		{
